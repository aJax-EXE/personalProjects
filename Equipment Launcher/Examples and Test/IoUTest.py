...
face_cascade_frontal = cv2.CascadeClassifier('HalloweenTurret/Haar Cascade Classifiers/haarcascade_frontalface_default.xml')
face_cascade_profile = cv2.CascadeClassifier('HalloweenTurret/Haar Cascade Classifiers/haarcascade_profileface.xml')
